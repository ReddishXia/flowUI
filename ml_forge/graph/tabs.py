...
_HINT_LINES = {
    ...
    "inference": [
        ...
        "",
        "Build your inference graph here:",
        "  1. Add an Inference Dataset node",
        "     (Inf MNIST, Inf CIFAR10, Inf ImageFolder, ...)",
        "  2. Add optional Inference Preprocess nodes",
        "     (Inf Resize, Inf Normalize, Inf ToTensor, ...)",
        "  3. Connect them into a checkpoint node",
        "     (pth, pt, or ckpt)",
        "  4. Connect the checkpoint to InferenceOutput",
        "  5. Open RUN -> Inference to execute the graph",
        "",
        "Inference uses its own dataset/preprocess nodes.",
    ],
    None: [
